        ...
        <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center gap-[10px]'>
                ...
                <div className='leading-[20px]'>
                    <h2 className='text-xl text-smallTextColor font-[700]'>Rizwanu</h2>
                    <p className='text-smallTextColor text-[16px] font-[500]'></p>
                    Rahman
                </div>
            </div>
            {/* ============= logo ============*/}
            ...
            <div className="menu" ref={menuRef} onClick={toggleMenu}>
                <ul className='flex items-center gap-10'>
                    ...
                    <li><a onClick={handleClick}  className=' text-smallTextColor font-[600]' href="#resume">Resume</a></li>
