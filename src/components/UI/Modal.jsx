...
const Modal = ({activeID,setShowModal}) => {
  ...
  return (
    <div className='w-full h-full fixed top-0 left-0 z-10 bg-headingColor bg-opacity-40 '>
        <div className=" port w-[500px]    absolute top-1/2 left-1/2 z-20 bg-white rounded-[8px] transform
            -translate-x-1/2 -translate-y-1/2 p-5">
               <div>
                <figure >
                    <img className='image rounded-[8px]' src={portfolio.imgUrl} alt="" />
                </figure>
               </div>
               ...
               <div>
                ...
                <a href={portfolio.siteUrl}>
                    <button  className='bg-primaryColor  text-white py-2 px-4 my-4 rounded-full font-[500]
                    hover:bg-headingColor ease-in duration-30'>
